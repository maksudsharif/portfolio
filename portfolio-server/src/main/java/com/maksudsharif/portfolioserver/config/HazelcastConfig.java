...
public class HazelcastConfig
{
  ...
  public Config hazelcastConfiguration()
  {
    ...
    if (networkEnableInterfaces) {
      Assert.notNull(networkInterfacesInterface,
          "Network interfaces required if HZ interfaces enabled");
    ...
    if (networkEnableAWS) {
      ...
      Assert.isTrue(networkEnableInterfaces,
          "AWS Configuration requires HZ interfaces to be enabled");
      Assert.notNull(networkInterfacesInterface,
          "AWS Configuration requires HZ network interfaces to be a valid IP/CIDR range");
      awsConfig
