    ...
    <div className="platform-visual" aria-label="Cloud platform architecture illustration">
      ...
      <div className="visual-content">
        ...
        <div className="core-node">
          ...
          <div>
            <span className="mono muted">ORCHESTRATION</span>
            <strong>Kubernetes / OpenShift</strong>
          </div>
        ...
        <div className="visual-footer mono">
          <span>
            <i className="pulse-dot" /> 42 workloads ready
          </span>
          <span className="muted">99.98% available</span>
        </div>
      </div>
    </div>
  )
      ...
      <div className="shell">
        <div className="section-heading split-heading">
          <div>
            ...
            <h2 id="expertise-heading">Platforms that make the hard things repeatable.</h2>
          </div>
          <p>
            I work at the intersection of infrastructure, software, security, and operations—turning
            complex systems into reliable paved roads for engineering teams.
          </p>
        </div>
    ...
    <section className="section proof" aria-labelledby="proof-heading">
      <div className="shell proof-layout">
        <div className="proof-copy">
          ...
          <h2 id="proof-heading">Measured in reliability, velocity, and scale.</h2>
          <p>
            Good platform work should disappear into the teams it enables. These are a few of the
      ...
      <div className="shell">
        <div className="section-heading split-heading">
          <div>
            ...
            <h2 id="experience-heading">A decade of shipping critical systems.</h2>
          </div>
          <p>
            From enterprise Java applications to self-service cloud platforms, I’ve stayed close to
            both the architecture and the operational consequences.
          </p>
        </div>
    ...
    <section className="section stack" id="stack" aria-labelledby="stack-heading">
      <div className="shell stack-layout">
        <div className="stack-intro">
          ...
          <h2 id="stack-heading">Deep enough to architect. Practical enough to operate.</h2>
          <p>
            My strongest work connects layers that are too often treated separately: application
            code, delivery systems, infrastructure, security, data, and operations.
          </p>
    ...
    <section className="section about" id="about" aria-labelledby="about-heading">
      <div className="shell about-layout">
        <div className="about-panel">
          <p className="overline">Beyond the architecture</p>
          <h2 id="about-heading">I care about the system after the diagram.</h2>
          <p className="about-lede">
            The best architecture survives contact with production—and makes the people operating it
            more effective.
          </p>
          <p>
            I lead from the work: partnering with customers, mentoring engineers, writing code,
            building runbooks, and staying present through rollout and incident response. I’m
            particularly interested in self-service platforms, distributed systems, and the craft of
            making complex infrastructure feel boring.
          </p>
        ...
        <blockquote>
          ...
          <p>
            Build the paved road, instrument it, document it, and make the safe path the easy path.
          </p>
          <footer>My platform engineering philosophy</footer>
        </blockquote>
      </div>
    </section>
  )
  ...
  return (
    <section className="contact" aria-labelledby="contact-heading">
      ...
      <div className="shell contact-inner">
        <p className="overline">Let's build something resilient</p>
        <h2 id="contact-heading">Have a hard cloud or platform problem?</h2>
        <p>
    ...
    <footer className="site-footer">
      <div className="shell footer-layout">
        <div>
          ...
          <p>Secure platforms. Reliable systems. Better developer experience.</p>
        </div>
